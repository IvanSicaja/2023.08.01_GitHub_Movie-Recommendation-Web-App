...
improvedMoviesDataset = pickle.load(open("../data/3.0_ExportedPickleFiles/compressedMoviesDataset.pkl", 'rb')) # Load edited movies dataset in compressed way
similarity = pickle.load(open("../data/3.0_ExportedPickleFiles/compressedSimilarityDataset.pkl", 'rb')) # Load calculated cosine similarities in compressed way
