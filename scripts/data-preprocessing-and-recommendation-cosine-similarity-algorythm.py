...
output_file_path_sparseMatrix = "../data/2.0_DataAnalyse/1.0_RowValuesSparseMatrix.txt"
output_file_path_array = "../data/2.0_DataAnalyse/2.0_RowValuesArray.txt"
output_file_path_tokensAndKeys = "../data/2.0_DataAnalyse/3.0_TokensAndKeys"
...
pickle.dump(improvedMoviesDataset, open('../data/3.0_ExportedPickleFiles/compressedMoviesDataset.pkl', 'wb')) # Exports edited movies dataset in compressed way
pickle.dump(similarity, open('../data/3.0_ExportedPickleFiles/compressedSimilarityDataset.pkl', 'wb')) # Exports calculated cosine similarities in compressed way
